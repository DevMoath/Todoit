<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="settings" id="settings"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title my-auto">Settings</h5>
                ...
                <div class="row">
                    <div class="col-3 border-right py-3">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" style="min-height: 400px"
                            ...
                            <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home"
                               role="tab" aria-controls="v-pills-home" aria-selected="true">Profile Information</a>
                            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile"
                               role="tab" aria-controls="v-pills-profile" aria-selected="false">Security</a>
                    ...
                    <div class="col-9">
                        <div class="tab-content py-3" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel">
                                ...
                                <form action="{{ route("user.destroy", auth()->id()) }}" id="delete_form" method="post">
                                    ...
                                    <button type="submit" id="delete_button"
                                        ...
                                        <i class="far fa-trash-alt fa-fw mr-1"></i>Delete Account
                                    </button>
                                </form>
                            </div>
                            ...
                            {{--                                        <label class="custom-control-label" for="dark">Dark Theme--}}
